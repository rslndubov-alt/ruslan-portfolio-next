...
export const translations = {
  en: {
    ...
    agent_greeting: 'Hi! I\'m Ruslan\'s AI assistant. Ask me anything about his work, tools, or collaborations!',
    agent_ask_button: '💬 Ask a question',
    agent_chip_arts: 'Show me AI artworks',
    agent_chip_video: 'Show me videos',
    agent_chip_order: 'I want to order a project',
    agent_send_brief: 'Send brief to Ruslan via Telegram',
    agent_donate: 'Buy Ruslan a coffee',
    brief_sent_success: '✅ Brief sent! Ruslan will reply within 24 hours.',
  ...
  uk: {
    ...
    agent_greeting: 'Привіт! Я AI-асистент Руслана. Запитайте про його роботи, інструменти чи співпрацю!',
    agent_ask_button: '💬 Поставити запитання',
    agent_chip_arts: 'Покажи AI арти',
    agent_chip_video: 'Покажи відео',
    agent_chip_order: 'Хочу замовити проєкт',
    agent_send_brief: 'Надіслати бріф Руслану в Telegram',
    agent_donate: 'Пригостити Руслана кавою',
    brief_sent_success: '✅ Бріф надіслано! Руслан відповість протягом 24 годин.',
  ...
  ru: {
    ...
    agent_greeting: 'Привет! Я AI-ассистент Руслана. Спросите меня о его работах, инструментах или сотрудничестве!',
    agent_ask_button: '💬 Задать вопрос',
    agent_chip_arts: 'Покажи AI арты',
    agent_chip_video: 'Покажи видео',
    agent_chip_order: 'Хочу заказать проект',
    agent_send_brief: 'Отправить бриф Руслану в Telegram',
    agent_donate: 'Угостить Руслана кофе',
    brief_sent_success: '✅ Бриф отправлен! Руслан ответит в течение 24 часов.',
