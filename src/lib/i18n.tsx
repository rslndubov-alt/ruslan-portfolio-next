...
export const translations = {
  en: {
    ...
    arts_desc: 'Deep exploration of latent space and diffusion networks (Midjourney) to create hyper-realistic visual concepts. Ultimate control over cinematic lighting, composition, and generative aesthetics through precision prompt engineering. Ensuring character consistency, complex stylization, and next-gen visual storytelling.',
    ...
    video_desc: 'Next-gen video production powered by artificial intelligence. A seamless pipeline from LLM-driven scriptwriting to AI cinematography and dynamic frame generation. Focused on temporal consistency, immersive storytelling, and seamless VFX integration to deliver truly cinematic wow-effects.',
    music_title: 'AI Music & Audio Generation',
    music_desc: 'Neuro-acoustic sound design and algorithmic track generation (Suno AI). Crafting complex audio architectures through meta-tagging and rhythm control. From heavy beats to emotional soundtracks—achieving perfect synergy between audio and visual narratives with studio-grade sound synthesis.',
  ...
  uk: {
    ...
    video_title: 'AI Video Production',
    video_desc: 'Next-gen відеопродакшн на базі штучного інтелекту. Безшовний пайплайн від розробки сценарних концептів у LLM до AI-режисури та динамічної генерації кадрів. Фокус на кінематографічності, темпоральній стабільності (temporal consistency) та іммерсивному сторітелінгу для створення wow-ефекту.',
    music_title: 'AI Music & Audio Generation',
    music_desc: 'Нейроакустичний саунд-дизайн та алгоритмічна генерація треків (Suno AI). Створення складної аудіо-архітектури через мета-тегування та контроль ритміки. Від потужних бітів до емоційних саундтреків — повна синергія музики та візуального наративу зі студійним рівнем звучання.',
  ...
  ru: {
    ...
    arts_title: 'AI Arts & Visual Research',
    arts_desc: 'Глубокое исследование латентного пространства и диффузионных нейросетей (Midjourney) для создания гиперреалистичных визуальных концептов. Ультимативный контроль над кинематографичным светом, композицией и генеративной эстетикой через ювелирный промпт-инжиниринг. Максимальная консистентность персонажей, сложная стилизация и визуальный сторителлинг нового поколения.',
